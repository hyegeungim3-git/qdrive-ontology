...
export default function DemoControls({ snap }: { snap: SimSnapshot }) {
  return (
    <div className="flex flex-wrap items-center gap-2">
      <span className="rounded-md border border-gray-800 bg-gray-900 px-2.5 py-1 font-mono text-sm text-emerald-400">{simClock(snap.simTime)}</span>
      ...
      <div className="flex flex-wrap items-center gap-1 rounded-md border border-dashed border-gray-800 px-2 py-1">
        ...
        <button
          ...
          className="rounded border border-red-500/40 bg-red-500/10 px-1.5 py-0.5 text-[11px] font-bold text-red-300 hover:bg-red-500/20"
        ...
        <button
          ...
          className="rounded border border-amber-500/40 bg-amber-500/10 px-1.5 py-0.5 text-[11px] font-bold text-amber-300 hover:bg-amber-500/20"
        ...
        <button
          ...
          className="rounded border border-violet-500/40 bg-violet-500/10 px-1.5 py-0.5 text-[11px] font-bold text-violet-300 hover:bg-violet-500/20"
        ...
        <button
          ...
          className="rounded border border-sky-500/40 bg-sky-500/10 px-1.5 py-0.5 text-[11px] font-bold text-sky-300 hover:bg-sky-500/20"
          title="배차 권고 생성 → 조치"
        >
          🚌 배차
        </button>
        <button
          ...
          className="rounded border border-gray-700 bg-gray-800/60 px-1.5 py-0.5 text-[11px] font-bold text-gray-300 hover:text-gray-100"
          title="날씨 전환 → 운행 맥락"
        >
          ☀️ 날씨
        </button>
